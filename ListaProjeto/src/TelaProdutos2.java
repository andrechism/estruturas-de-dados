...
public class TelaProdutos2 extends JFrame {
	...
	private JLabel lbConsultaCodigo;
	private JTextField tfConsultaCodigo;
	...
	public TelaProdutos2() {
		...
		this.lbConsultaCodigo = new JLabel("Consultar por Código:");
		this.lbConsultaCodigo.setBounds(20, 140, 150, 20);
		this.tfConsultaCodigo = new JTextField("");
		this.tfConsultaCodigo.setBounds(20, 165, 350, 25);
		this.btConsultaCodigo = new JButton("Consultar");
		this.btConsultaCodigo.setBounds(400, 165, 200, 25);
		...
		this.add(lbConsultaCodigo);
		this.add(tfConsultaCodigo);
	...
	public JLabel getLbConsultaCodigo() {
		return lbConsultaCodigo;
	}

	public void setLbConsultaCodigo(JLabel lbConsultaCodigo) {
		this.lbConsultaCodigo = lbConsultaCodigo;
	}

	public JTextField getTfConsultaCodigo() {
		return tfConsultaCodigo;
	}

	public void setTfConsultaCodigo(JTextField tfConsultaCodigo) {
		this.tfConsultaCodigo = tfConsultaCodigo;
	}
